 ...
 * @file	stm32f4xx.h
 * @brief	It defines Registers, Bits and Macros
 * 			It includes the ST Standard Peripheral Driver
 */
...
/*----------Includes----------------------------------------------------------*/
#include "stm32f4xx_StdFrameworkConfig.h"
...
/*----------Include ST Standard Peripheral Driver-----------------------------*/
#include "StdPeriphLib\stm32f4xx_StdPeriphLib.h"
